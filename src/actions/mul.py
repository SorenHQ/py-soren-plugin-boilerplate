...
class Mul(IAction):
    ...
    def getParams(self):
        return {
            "name": "mul",        # Unique identifier for the action
            "title": "Multiply",      # Human-readable action title
            "description": "Multiply 2 numbers", # action description
            "params": [ # a list of required parameters
                ...
                "options":[],
                "key": "number_a",                # Parameter name
                "placeholder": "input number #1", # Input placeholder for front-end view
                ...
                "options":[],
                "key": "number_b",                # Parameter name
                "placeholder": "input number #2", # Input placeholder for front-end view
                "value": [],        # Default value, and values themselves
                "title": "Enter Number",        # Parameter title
                "description": "Enter numbers" # Parameter description
                },
