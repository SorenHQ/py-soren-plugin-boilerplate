...
class Add(IAction):
    def run(self,input):
        ...
        return sum([num for num in numbersValue])


    def getParams(self):
        return {
            "name": "add",        # Unique identifier for the action
            "title": "Add",      # Human-readable action title
            "description": "add numbers", # action description
